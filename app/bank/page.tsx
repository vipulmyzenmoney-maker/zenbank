                  ...
                  {paginatedQuestions.map((q) => {
                    ...
                    return (
                      <Fragment key={q.id}>
                          ...
                          <td className="px-4 py-3 max-w-sm">
                            <div className="flex items-start gap-2">
                              <button
                                ...
                                title={isExpanded ? "Hide explanation" : "View kid-friendly explanation & options"}
                              >
                                {isExpanded ? (
                              ...
                              >
                                <span className="text-xs font-semibold text-slate-200 group-hover:text-emerald-300 line-clamp-2 transition-colors">
                                  {q.questionText}
                                </span>
                              </button>
                            </div>
                        ...
                        {/* Expandable Question Details & Kid-Friendly Explanation */}
                        {isExpanded && (
