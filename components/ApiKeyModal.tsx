      ...
      <div className="relative w-full max-w-md max-h-[88vh] overflow-y-auto my-auto rounded-2xl sm:rounded-3xl border border-slate-800 bg-slate-900 p-4 sm:p-6 shadow-2xl">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-display text-sm sm:text-base font-bold text-white">AI Engine & Vision Settings</h3>
              <p className="text-[10px] sm:text-[11px] text-slate-400">Optional: Configure custom AI model keys</p>
            </div>
          </div>
          <button
            onClick={onClose}
